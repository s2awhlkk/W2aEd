...
$API_KEY = "7294269667:AAFdx-a3cvlcuEaHt1kAoUnzJa8-eXYFJdk";
...
𖠮︙ [تحديثات السورس الجديده](https://t.me/YYYYF)",
'parse_mode'=>"markdown",
...
[['text'=>"🎭قناة السورس 𖠮",'url'=>"t.me/YYYYF"]],
]])
]); 
}
}
...
[['text'=>"M𝔸Tℝ𝕀X",'url'=>"https://t.me/YYYYF"]],
]])]);}
$ex = explode("#",$data);
...
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'inline_keyboard'=>[[['text'=>"- M𝔸Tℝ𝕀X .",'url'=>"t.me/YYYYF"]],]])]);}}
#┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
$re = $update->message->reply_to_message;
...
[['text'=>"⌁⁞ 𝙳𝙴𝚅 ⁞⌁",'url'=>"t.me/F_UIII"],['text'=>"⌁⁞ 𝙲𝙷  ⁞⌁",'url'=>"t.me/YYYYF"]],
]])
]); 
}
############     
...
𖠮︙[تفاصيل الملف](https://t.me/YYYYF/2)
",'parse_mode'=>"markdown",'disable_web_page_preview'=>true,
  'reply_to_message_id'=>$message_id,
'reply_markup'=>$inlinebutton,
 ]);
...
𖠮︙تم تفعيله في البوت بنجاح
𖠮︙[تفاصيل الملف](https://t.me/YYYYF/3)
",'parse_mode'=>"markdown",'disable_web_page_preview'=>true,
  'reply_to_message_id'=>$message_id,
'reply_markup'=>$inlinebutton,
 ]);
...
𖠮︙تم تفعيله في البوت بنجاح
𖠮︙[تفاصيل الملف](https://t.me/YYYYF/4)
",'parse_mode'=>"markdown",'disable_web_page_preview'=>true,
  'reply_to_message_id'=>$message_id,
'reply_markup'=>$inlinebutton,
 ]);
...
𖠮︙تم تفعيله في البوت بنجاح
𖠮︙[تفاصيل الملف](https://t.me/YYYYF/5)
",'parse_mode'=>"markdown",'disable_web_page_preview'=>true,
  'reply_to_message_id'=>$message_id,
'reply_markup'=>$inlinebutton,
 ]);
...
𖠮︙تم تفعيله في البوت بنجاح
𖠮︙[تفاصيل الملف](https://t.me/YYYYF/7)
",'parse_mode'=>"markdown",'disable_web_page_preview'=>true,
  'reply_to_message_id'=>$message_id,
'reply_markup'=>$inlinebutton,
 ]);
...
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
𖠮︙[ملف العاب اونلاين](https://t.me/YYYYF/3) ↫ ⤈
1~ : game ↬ ($gamejson)
𖠮︙[ملف زخرفه](https://t.me/YYYYF/4) ↫ ⤈
2~ : Zhrafa ↬ ($Zhrafajson)
𖠮︙[ملف تنبيه عند تغير الاسم](https://t.me/YYYYF/5) ↫ ⤈
3~ : ChangeName ↬ ($ChangeName)
𖠮︙[ملف تنبيه عند تغير المعرف](https://t.me/YYYYF/6) ↫ ⤈
4~ : ChangeUser ↬ ($ChangeUser)
𖠮︙[ملف تنبيه عند تغير الصورة](https://t.me/YYYYF/7) ↫ ⤈
...
bot("sendmessage",['chat_id'=>$chat_id,'text'=>"
⦑ Welcome to Source a promise ⦒
 source by sajad
 source by team satisfaction
...
#######
$Sajad = file_get_contents("data/Sajad.json");
...
file_put_contents("data/Sajad.json","Sajad");
} 
if($text =="/start" and $Sajad == "Sajad" and $from_id != $admin) {
$times = date('h:i:s');
$pirvate = explode("\n",file_get_contents("Fri3nd_s/pirvate.txt"));
$forward = $update->message->forward_from;
...
𖠮︙تغير الايدي ↫ تغ
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
[SoUrcE matrxx](https://t.me/YYYYF)",
'parse_mode'=>"markdown",'reply_to_message_id'=>$message_id,
 ]);
 } 
...
echo "It was leaked through sajad ";